...
{
    public partial class Modify_sp_GetProjectSummary : Migration
    {
											...
											,ISNULL(
											 ...
											 ,ISNULL(
												 CASE
												  ...
												  END, 0) TotalLogHours
										FROM AspNetUsers U  
										LEFT JOIN Invitations INV ON U.Email = INV.Email
										LEFT JOIN Projects P ON INV.ProjectId = P.Id
										LEFT JOIN ProjectUsers PU ON INV.ProjectId = PU.ProjectId
