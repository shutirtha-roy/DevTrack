...
namespace DevTrack.Infrastructure.Services
{
    public interface IProjectService
    {
        ...
        Task<(IList<string> ownerProjectTitles, IList<string> workerProjectTitles, IList<double> loggedHoursPerOwnerProject, IList<double> loggedHoursPerWorkerProject, IList<double> loggedHoursPerMonthOwner, IList<double> loggedHoursPerMonthWorker)> GetLoggedHoursPerProject(Guid userId);
    }
}